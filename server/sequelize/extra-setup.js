function applyExtraSetup(sequelize) {
	...
	mineralComposition.belongsToMany(mineral, { through: 'mineral2mineralComposition' });
	mineral.belongsToMany(mineralComposition, { through: 'mineral2mineralComposition' });
	...
	section.belongsTo(sectionPhoto);
	sectionPhoto.hasMany(section);

	section.belongsTo(chemicalComposition);
	chemicalComposition.hasMany(section);

	chemicalComposition.belongsToMany(chemicalElement, { through: 'chemicalElement2chemicalComposition' });
	chemicalElement.belongsToMany(chemicalComposition, { through: 'chemicalElement2chemicalComposition' });
